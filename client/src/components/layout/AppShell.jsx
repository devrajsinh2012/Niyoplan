...
import { LayoutDashboard, FolderKanban, Settings, LogOut, Loader2 } from 'lucide-react';
...
export default function AppShell() {
  ...
  return (
    <div className="flex h-screen w-full bg-[#0F172A] text-slate-200 overflow-hidden font-inter">
      
      {/* Global Sidebar */}
      <aside className="w-[68px] flex flex-col items-center py-4 bg-[#1E293B] border-r border-slate-800 shadow-2xl relative z-20">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col h-full bg-[#0F172A] overflow-hidden relative z-10">
