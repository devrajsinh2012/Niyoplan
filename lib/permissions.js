...
export const PERMISSION_DEFINITIONS = [
  {
    key: 'create_issue',
    label: 'Create Tasks',
    description: 'Can create new project tasks/cards.'
  },
  {
    key: 'edit_issue',
    label: 'Edit Tasks',
    description: 'Can update task fields and details.'
  },
  {
    key: 'delete_issue',
    label: 'Delete Tasks',
    description: 'Can permanently delete tasks/cards.'
  },
  {
    key: 'manage_members',
  ...
  },
  {
    key: 'view_clients',
    label: 'View Clients',
    description: 'Can view company clients, contacts, reminders, interactions, and deliverables.'
  },
  {
    key: 'manage_clients',
    label: 'Manage Clients',
    description: 'Can create and update clients, reminders, interactions, contacts, and deliverables.'
  }
];

const DEFAULT_ROLE_PERMISSIONS = {
  admin: ['create_issue', 'edit_issue', 'delete_issue', 'manage_members', 'manage_sprints', 'manage_settings', 'view_clients', 'manage_clients'],
  pm: ['create_issue', 'edit_issue', 'manage_members', 'manage_sprints', 'view_clients', 'manage_clients'],
