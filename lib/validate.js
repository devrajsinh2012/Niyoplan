...
/**
 * Backward-compatible UUID check used by legacy tests and callers.
 * @param {string} value
 * @returns {boolean}
 */
...
/**
 * Backward-compatible non-empty string check used by legacy tests and callers.
 * @param {string} value
 * @returns {boolean}
 */
...
export function validateEnum(value, fieldName, allowed) {
  if (Array.isArray(fieldName) && allowed === undefined) {
